...
public:
	...
	static IPhysicalLayerWrapper* FGetSerialAsync(SerialSettings s, asio::io_service* apSrv, Logger* apLogger);
	static IPhysicalLayerAsync* FGetTCPClientAsync(std::string aAddress, uint16_t aPort, asio::io_service* apSrv, Logger* apLogger);
	static IPhysicalLayerAsync* FGetTCPServerAsync(std::string aEndpoint, uint16_t aPort, asio::io_service* apSrv, Logger* apLogger);
};
}
