...
DNP3Channel::DNP3Channel(Logger* apLogger, millis_t aOpenRetry, asio::io_service* apService, IPhysicalLayerAsync* apPhys, ITimeSource* apTimeSource, std::function<void (DNP3Channel*)> aOnShutdown) :
	Loggable(apLogger),
	mpService(apService),
	mpPhys(apPhys),
